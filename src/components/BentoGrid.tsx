...
export const BentoGrid: React.FC = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-6 h-auto md:h-[750px]">
      ...
      <div className="md:col-span-2 md:row-span-2 relative group overflow-hidden bg-[#1a1c1c] rounded-xl border border-[#4d4635]/40 hover:border-[#f2ca50]/70 transition-all duration-500 shadow-2xl">
        <img
        ...
        {/* Badge Prestige */}
        <div className="absolute top-6 right-6 flex items-center gap-2 bg-[#0c0f0f]/85 backdrop-blur-md px-4 py-2 border border-[#f2ca50]/40 rounded-full shadow-[0_0_15px_rgba(242,202,80,0.25)]">
        ...
        <div className="absolute bottom-0 left-0 w-full p-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
          <div>
            <p className="font-['Hanken_Grotesk'] text-xs text-[#f2ca50] font-bold tracking-widest mb-1.5">
              VILLA CONTEMPORAINE D'EXCEPTION
            </p>
            <h3 className="font-['Playfair_Display'] font-bold text-2xl md:text-3xl text-[#e2e2e2] mb-3">
              Palais des Ambassadeurs, Yaoundé
            </h3>
            <div className="flex gap-6 text-sm text-[#d0c5af] font-['Manrope']">
              <span className="flex items-center gap-1.5">
                <Maximize2 className="w-4 h-4 text-[#f2ca50]" /> 450 m²
              </span>
              <span className="flex items-center gap-1.5">
                <Bed className="w-4 h-4 text-[#f2ca50]" /> 5 Chambres
              </span>
            </div>
          </div>

          <div className="flex flex-col items-start md:items-end gap-3">
            <span className="font-['Playfair_Display'] font-bold text-2xl text-[#f2ca50]">
              3 400 000 000 FCFA
            </span>
            <Link
              to="/property/1"
              className="inline-flex items-center gap-2 bg-[#f2ca50] text-[#3c2f00] font-['Hanken_Grotesk'] font-bold text-xs tracking-wider px-5 py-2.5 rounded hover:bg-[#ffe088] transition-all shadow-[0_0_15px_rgba(242,202,80,0.3)]"
            >
      ...
      <div className="relative group overflow-hidden bg-[#1a1c1c] rounded-xl border border-[#4d4635]/40 hover:border-[#f2ca50]/70 transition-all duration-500 shadow-xl">
        <img
        ...
        <div className="absolute top-4 right-4 flex items-center gap-1 bg-[#0c0f0f]/80 backdrop-blur px-3 py-1 border border-[#f2ca50]/30 rounded-full">
        ...
        <div className="absolute bottom-0 left-0 w-full p-6">
          ...
          <h3 className="font-['Playfair_Display'] font-semibold text-lg text-[#e2e2e2] mb-2">
            Penthouse Panoramique Bonanjo
          </h3>
          <p className="font-['Playfair_Display'] font-bold text-lg text-[#f2ca50]">
            2 065 000 000 FCFA
          </p>
        </div>
      </div>
